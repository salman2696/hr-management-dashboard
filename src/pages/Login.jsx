...
const Login = () => {
  ...
  const { setAuth } = useContext(AuthContext); // Get setAuth function from AuthContext
    ...
    <div>
      <section className="bg-gray-50 dark:bg-gray-900">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0">
          <a
            href="#"
            className="flex items-center mb-6 lg:text-lg font-semibold text-gray-900 dark:text-white"
          >
            <img className="w-12 h-8 mr-2" src={Logo} alt="logo" />
            Engineering & Environmental Solutions Pvt. Ltd
          </a>
